...
void loop() {
  ...
  if (cmd == "stand") {
    setFootPos(0, DEFAULT_X, 0, STAND_Z_F, 1000);
    setFootPos(1, DEFAULT_X, 0, STAND_Z_F, 1000);
    setFootPos(2, DEFAULT_X, 0, STAND_Z_B, 1000);
    setFootPos(3, DEFAULT_X, 0, STAND_Z_B, 1000);
    waitAllReach();
    cmd = "";
  }
  ...
  if (cmd == "walk") {
    ...
    for (int i=1; i<32; i++) {
      setFootPos(0, walkPosF2[i%8][0], walkPosF2[i%8][1], walkPosF2[i%8][2], 100);
      setFootPos(3, walkPosB2[i%8][0], walkPosB2[i%8][1], walkPosB2[i%8][2], 100);

      setFootPos(1, walkPosF2[(i+4)%8][0], walkPosF2[(i+4)%8][1], walkPosF2[(i+4)%8][2], 100);
      setFootPos(2, walkPosB2[(i+4)%8][0], walkPosB2[(i+4)%8][1], walkPosB2[(i+4)%8][2], 100);
      waitAllReach();
    }
    Serial.println("wlak done____________________");

    setFootPos(1, DEFAULT_X, 0, STAND_Z_F-3, 100);
    setFootPos(2, DEFAULT_X, 0, STAND_Z_B-3, 100);
    waitAllReach();
    setFootPos(1, DEFAULT_X, 0, STAND_Z_F, 200);
    setFootPos(2, DEFAULT_X, 0, STAND_Z_B, 200);
    waitAllReach();
    setFootPos(0, 0, 0, STAND_Z_F-3, 100);
    setFootPos(3, 0, 0, STAND_Z_B-3, 100);
    waitAllReach();
    setFootPos(0, 0, 0, STAND_Z_F, 150);
    setFootPos(3, 0, 0, STAND_Z_B, 150);
    waitAllReach();
    cmd = "stand";
  }
  ...
  if (cmd == "turn") {
    ...
    Serial.println("wlak done____________________");
    setFootPos(1, 0, 0, STAND_Z_F-3, 100);
    setFootPos(2, 0, 0, STAND_Z_B-3, 100);
    waitAllReach();
    setFootPos(1, 0, 0, STAND_Z_F, 150);
    setFootPos(2, 0, 0, STAND_Z_B, 150);
    waitAllReach();
    cmd = "stand";
  }
}
...
void printE() {
  ...
  Serial.println(posNow[0][0] == posExpect[0][0]);
